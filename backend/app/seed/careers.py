...
⚠️ สถานะข้อมูล — อ่านก่อนอ้างอิงบนเวที
   ...
   ท่อขั้นที่ 2 (`pipeline/2_extract_postings.py`) จะเขียนทับไฟล์นี้เมื่อ
   (ก) เก็บประกาศงานจริง 30–50 อันได้แล้ว และ (ข) มี LLM API key
   ตอนนั้น `posting_count` และ `appears_in_n_postings` จะมีค่าจริง และหน้าจอจะแสดงมัน
...
CAREER_TARGETS: list[dict] = [
    {
        ...
        "min_education": "ปี 3",
        "min_gpa": 2.50,
        "summary": "สร้างระบบที่คนใช้จริงทุกวัน และดูแลให้มันไม่พังเมื่อมีคนใช้เพิ่มขึ้น",
        "day_in_the_life": (
    ...
    },
    {
        ...
        "min_education": "ปี 3",
        "min_gpa": 2.50,
        "summary": "ทำให้ข้อมูลที่กระจัดกระจายไหลมารวมกันจนหัวหน้างานตัดสินใจได้เร็วขึ้น",
        "day_in_the_life": (
    ...
    },
    {
        ...
        "min_education": "ปี 2",
        "min_gpa": 2.75,
        "summary": "ทำให้เครื่องจักรขยับเองได้ตามที่ต้องการ และหยุดเมื่อควรหยุด",
        "day_in_the_life": (
    ...
    },
    {
        ...
        "min_education": "ปี 3",
        "min_gpa": 2.50,
        "summary": "ทำให้สิ่งที่คนเข้าไปใช้ทุกวันตั้งอยู่ได้ และพิสูจน์ด้วยตัวเลขว่ามันจะไม่พัง",
        "day_in_the_life": (
    ...
    },
    {
        ...
        "min_education": "ปี 3",
        "min_gpa": None,
        "summary": "เปลี่ยนของอย่างหนึ่งเป็นอีกอย่างในระดับที่ผลิตขายได้จริงและปลอดภัย",
        "day_in_the_life": (
    ...
    },
    {
        ...
        "min_education": "ปี 3",
        "min_gpa": None,
        "summary": "หาจุดที่ระบบเสียเวลาและเสียของ แล้วทำให้มันเสียน้อยลงโดยไม่ต้องซื้อของเพิ่ม",
        "day_in_the_life": (
    ...
    },
    {
        ...
        "min_education": "ปี 3",
        "min_gpa": 3.00,
        "summary": "วางแผนว่าไฟฟ้าจะพอใช้ในอีก 10 ปี และพลังงานทดแทนจะเสียบเข้าระบบตรงไหน",
        "day_in_the_life": (
    ...
    },
    {
        ...
        "min_education": "ปี 3",
        "min_gpa": 2.50,
        "summary": "ออกแบบของที่ขยับได้ ทนแรงได้ และผลิตออกมาได้จริงในงบที่มี",
        "day_in_the_life": (

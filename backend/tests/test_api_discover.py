...
# 🔴 คำที่ใช้จำลองต้องเป็น "การลงมือ" หรือ "ของที่จับต้องได้" เท่านั้น
#    เคยมี "โครงสร้าง" อยู่ในชุดนี้ แล้วพัง เพราะมันเป็นคำเรียกสิ่งของ ไม่ใช่การกระทำ
#    จึงไปโผล่ในข้อที่เป็นงานวิเคราะห์บนโต๊ะด้วย (เช่น 4.A.1.b.2 ตรวจหารอยร้าวบนโครงสร้าง)
#    ผลคือคนจำลองตอบ "อยากทำ" ทั้ง 4 ข้อ ไม่เหลือข้อลบให้เทียบ เครื่องยนต์เลยจัดอันดับไม่ได้
HANDS_ON = ("เครื่อง", "ซ่อม", "ประกอบ", "ติดตั้ง", "วัสดุ", "หน้างาน", "มือ")

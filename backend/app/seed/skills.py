...
_S = [
    ...
    # ══════════ โยธา ══════════
    ("CE-STATIC", "เช็กแรงในโครงสร้างว่าไหวและปลอดภัยไหม", "civil", None, "manual"),
    ("CE-MATERIAL", "ทดสอบวัสดุก่อสร้างแล้วสรุปผลให้เข้าใจง่าย", "civil", "onet-quality-control-analysis", "onet"),
    ("CE-RC", "ออกแบบคานและเสาคอนกรีตให้รับแรงไหว", "civil", None, "manual"),
    ("CE-SURVEY", "ใช้กล้องวัดระดับเก็บข้อมูลพื้นที่หน้างาน", "civil", None, "manual"),
    ("CE-BIM", "ทำโมเดลอาคาร 3 มิติให้ทีมทำงานต่อกันได้", "civil", "tool-autodesk-revit", "onet"),
    ("CE-COST", "ตีราคาค่าวัสดุและค่าแรงของงานก่อสร้าง", "civil", None, "manual"),
    ("CE-FEM", "ใช้โปรแกรมจำลองดูว่าโครงสร้างรับแรงไหวไหม", "civil", "tool-finite-element-analysis-fea-software", "onet"),

    # ══════════ เคมี ══════════
    ("CH-MASS", "ตามวัตถุดิบเข้า–ออกในกระบวนการผลิตให้ครบ", "chemical", None, "manual"),
    ("CH-ENERGY", "คำนวณว่ากระบวนการผลิตใช้พลังงานเท่าไร", "chemical", None, "manual"),
    ("CH-LAB", "ทำแล็บอย่างปลอดภัยและทำซ้ำได้ผลใกล้เคียงเดิม", "chemical", "onet-chemistry", "onet"),
    ("CH-PFD", "อ่านและวาดแผนผังกระบวนการผลิต (P&ID)", "chemical", None, "manual"),
    ("CH-KIN", "ดูจากผลทดลองว่าปฏิกิริยาเกิดเร็วแค่ไหน", "chemical", "onet-science", "onet"),
    ("CH-SIM", "ใช้โปรแกรมลองจำลองกระบวนการผลิตก่อนทำจริง", "chemical", None, "market"),
    ("CH-SAFE", "มองหาความเสี่ยงในกระบวนการและวางวิธีป้องกัน", "chemical", "onet-production-and-processing", "onet"),

    # ══════════ ไฟฟ้า ══════════
    ("EE-CIRCUIT", "อ่านวงจรไฟฟ้าพื้นฐานแล้วคำนวณหาคำตอบได้", "electrical", "onet-computers-and-electronics", "onet"),
    ("EE-MEASURE", "ใช้มัลติมิเตอร์และออสซิลโลสโคปวัดสัญญาณจริง", "electrical", "onet-troubleshooting", "onet"),
    ("EE-ANALOG", "ออกแบบวงจรแอนะล็อกแล้วจำลองก่อนต่อจริง", "electrical", "tool-simulation-program-with-integrated-circu", "onet"),
    ("EE-PCB", "ออกแบบแผงวงจรให้สั่งผลิตและใช้งานได้", "electrical", None, "market"),
    ("EE-DSP", "แยกสัญญาณที่ต้องการออกจากสัญญาณรบกวน", "electrical", None, "manual"),
    ("EE-CTRL", "ออกแบบระบบควบคุมให้เครื่องทำงานนิ่ง", "electrical", "tool-mathworks-simulink", "onet"),
    ("EE-POWER", "ออกแบบระบบไฟฟ้ากำลังและต่อพลังงานสะอาดเข้าระบบ", "electrical", None, "manual"),
    ("EE-PLC", "เขียนโปรแกรม PLC ให้คุมสายการผลิตได้", "electrical", "tool-programmable-logic-controller-plc-softwa", "onet"),

    # ══════════ อุตสาหการ ══════════
    ("IE-FLOW", "วาดลำดับขั้นตอนการทำงานจริงให้เห็นภาพ", "industrial", "tool-microsoft-visio", "onet"),
    ("IE-TIME", "จับเวลาเพื่อหาจุดที่งานติดขัด", "industrial", None, "manual"),
    ("IE-SPC", "ใช้กราฟดูว่ากระบวนการเริ่มผิดปกติตอนไหน", "industrial", "tool-minitab", "onet"),
    ("IE-LAYOUT", "จัดผังพื้นที่ทำงานให้งานไหลลื่น", "industrial", None, "manual"),
    ("IE-SIM", "ใช้โปรแกรมจำลองคิวและสายการผลิต", "industrial", "tool-rockwell-automation-arena", "onet"),
    ("IE-LP", "เลือกวิธีที่คุ้มที่สุดภายใต้ข้อจำกัด", "industrial", "onet-operations-analysis", "onet"),
    ("IE-SCM", "วางแผนสต็อกและการส่งของจากข้อมูลจริง", "industrial", None, "manual"),
    ("IE-LEAN", "ลดขั้นตอนที่ไม่จำเป็น แล้ววัดผลที่ดีขึ้น", "industrial", None, "market"),

    # ══════════ เครื่องกล ══════════
    ("ME-STATICS", "เช็กแรงและความเค้นว่าชิ้นส่วนรับไหวไหม", "mechanical", None, "manual"),
    ("ME-MATERIAL", "เลือกวัสดุและวิธีผลิตให้เหมาะกับงานและงบ", "mechanical", "onet-engineering-and-technology", "onet"),
    ("ME-FAB", "ทำชิ้นงานต้นแบบด้วยเครื่องมือในโรงงาน", "mechanical", None, "manual"),
    ("ME-THERMO", "ดูการไหลและการถ่ายเทความร้อนในระบบ", "mechanical", "tool-ansys-fluent", "onet"),
    ("ME-MACHINE", "ออกแบบชุดกลไกให้ได้ความเร็วและแรงบิดตามต้องการ", "mechanical", None, "manual"),
    ("ME-FEA", "ใช้โปรแกรมจำลองดูว่าชิ้นส่วนรับแรงไหวไหม", "mechanical", "tool-ansys-simulation-software", "onet"),
    ("ME-MECHATRONIC", "ประกอบและทดสอบระบบที่มีกลไกกับไฟฟ้าทำงานร่วมกัน", "mechanical", "tool-national-instruments-labview", "onet"),
